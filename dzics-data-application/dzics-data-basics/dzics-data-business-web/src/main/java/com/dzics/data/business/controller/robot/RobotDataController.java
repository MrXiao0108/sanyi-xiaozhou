package com.dzics.data.business.controller.robot;
...
public class RobotDataController {
    ...
    @Autowired
    EquipmentService dzEquipmentService;
...
//    @OperLog(operModul = "分页查询机器人数据列表", operType = OperType.QUERY, operDesc = "分页查询机器人数据列表", operatorType = "后台")
    ...
    public Result<EquipmentDataDo> listEquipmentData(SelectEquipmentDataVo dataVo,
        ...
        dataVo.setEquipmentType(EquiTypeEnum.JQR.getCode());
        Result listResult = dzEquipmentService.listEquipmentData(sub, EquiTypeEnum.JQR.getCode(), dataVo);
        return listResult;
    }
}
