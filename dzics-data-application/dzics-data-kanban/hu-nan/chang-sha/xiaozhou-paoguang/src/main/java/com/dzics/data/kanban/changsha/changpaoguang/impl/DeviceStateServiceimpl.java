...
@Service
@Slf4j
public class DeviceStateServiceimpl implements DeviceStateService , ConvertDeviceStateService<List<MachiningMessageStatus>,List<DeviceStateDo>> {
    ...
    public List<MachiningMessageStatus> toMachiningMessageStatus(List<DeviceStateDo> dataList) {
        ...
        for (DeviceStateDo data : dataList) {
            ...
            if (i == 3 || i == 2) {
                ...
                status.setEquipmentName(data.getEquipmentName());
                status.setX("0.000");
                status.setY("0.000");
                status.setZ("0.000");
                String str = "";
                if (i == 3) {//机器人
                    str = tcpStringUtil.getCmdNameV2("A502", data.getA502());
                    ...
                    str = tcpStringUtil.getCmdNameV2("B501", data.getB501());
